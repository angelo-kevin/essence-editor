...
class EditRule extends Component {
    ...
    saveRule(){
        axios.put('http://localhost:8085/rules/' + this.state.rule._id, this.state.rule).then(res => {
            console.log(res)
        ...
        if (rule){
            return (
                    <div className={classes.paper}>
                        <text style={{fontSize: "200%"}}>Edit Rule</text>
                    <br/>
                    <br/>
...
export default withStyles(styles)(EditRule);
